...
public:
  ...
  virtual vec_basic get_args() const { return {_direction}; }
  ...
  inline RCP<const Number> get_direction() const { return _direction; }

  bool is_unsigned_infinity() const;
  bool is_positive_infinity() const;
  bool is_negative_infinity() const;

  inline bool is_positive() const { return is_positive_infinity(); }

  inline bool is_negative() const { return is_negative_infinity(); }

  inline bool is_complex() const { return is_unsigned_infinity(); }
...
inline RCP<const Infty> infty(int n = 1) { return make_rcp<Infty>(integer(n)); }
