...
bool mp_root(integer_class &res, const integer_class &i,
             const unsigned long n) {
  if (n == 0) {
...
struct two_by_two_matrix {
  ...
  static two_by_two_matrix identity() { return two_by_two_matrix(1, 0, 0, 1); }
};
