...
public:
  ...
  virtual inline vec_basic get_args() const { return {arg_}; }
  ...
  virtual inline bool __eq__(const Basic &o) const {
    return is_same_type(*this, o) and
           eq(*get_arg(), *down_cast<const OneArgFunction &>(o).get_arg());
  }
...
template <class BaseClass> class TwoArgBasic : public BaseClass {
private:
...
public:
  ...
  //! \return `arg_`
  inline RCP<const Basic> get_arg1() const { return a_; }
  //! \return `arg_`
  inline RCP<const Basic> get_arg2() const { return b_; }
  virtual inline vec_basic get_args() const { return {a_, b_}; }
  //! Method to construct classes with canonicalization
  ...
  virtual inline bool __eq__(const Basic &o) const {
    return is_same_type(*this, o) and
           eq(*get_arg1(), *down_cast<const TwoArgBasic &>(o).get_arg1()) and
           eq(*get_arg2(), *down_cast<const TwoArgBasic &>(o).get_arg2());
  }
  //! Structural equality comparator
  virtual inline int compare(const Basic &o) const {
    SYMENGINE_ASSERT(is_same_type(*this, o))
...
public:
  ...
  virtual inline vec_basic get_args() const { return arg_; }
  inline const vec_basic &get_vec() const { return arg_; }
  //! Method to construct classes with canonicalization
  ...
  virtual inline int compare(const Basic &o) const {
    SYMENGINE_ASSERT(is_same_type(*this, o))
    return unified_compare(get_vec(),
                           down_cast<const MultiArgFunction &>(o).get_vec());
  }
};
...
public:
  ...
  inline RCP<const Basic> get_num() const { return get_arg1(); }
  //! \return `x` in `atan2(y, x)`
  inline RCP<const Basic> get_den() const { return get_arg2(); }
...
public:
  ...
  //! \return `s_`
  inline RCP<const Basic> get_s() const { return get_arg1(); }
  //! \return `a_`
  inline RCP<const Basic> get_a() const { return get_arg2(); }
  //! \return `true` if canonical
...
public:
  ...
  //! \return `s`
  inline RCP<const Basic> get_s() const { return get_arg(); }
  //! \return `true` if canonical
...
public:
  ...
  virtual int compare(const Basic &o) const;
  inline RCP<const Basic> get_arg() const { return arg_; }
  inline const multiset_basic &get_symbols() const { return x_; }
...
public:
  ...
  virtual bool __eq__(const Basic &o) const;
  virtual int compare(const Basic &o) const;
  inline const RCP<const Basic> &get_arg() const { return arg_; }
