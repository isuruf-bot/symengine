...
public:
  ...
  void bvisit(const Basic &x) { throw SymEngineException("Not supported"); }
  ...
  void bvisit(const EmptySet &x) { throw SymEngineException("Not supported"); }
  void bvisit(const FiniteSet &x) { throw SymEngineException("Not supported"); }
  ...
  void bvisit(const Subs &x) { throw SymEngineException("Not supported"); }
