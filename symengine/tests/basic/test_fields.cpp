...
TEST_CASE("GaloisFieldDict distinct degree factorization : Basic", "[basic]") {
  ...
  REQUIRE(
      b[3].first ==
      GaloisFieldDict::from_vec(
          {1_z, 1_z, 0_z, 1_z, 1_z, 0_z, 1_z, 0_z, 1_z, 1_z, 0_z, 1_z, 1_z, 0_z,
           0_z, 0_z, 0_z, 0_z, 0_z, 0_z, 0_z, 1_z, 1_z, 0_z, 1_z, 1_z, 0_z, 1_z,
           0_z, 1_z, 1_z, 0_z, 1_z, 1_z, 0_z, 0_z, 0_z, 0_z, 0_z, 0_z, 0_z, 0_z,
           1_z, 1_z, 0_z, 1_z, 1_z, 0_z, 1_z, 0_z, 1_z, 1_z, 0_z, 1_z, 1_z},
          2_z));
...
TEST_CASE("GaloisFieldDict equal degree factorization : Basic", "[basic]") {
  ...
  d1 = GaloisFieldDict::from_vec({1_z, -3_z, -1_z, -3_z, 1_z, -3_z, 1_z}, 11_z);
  f = d1.gf_zassenhaus();
  REQUIRE(f.size() == 3);
...
TEST_CASE("GaloisFieldDict factorization : Basic", "[basic]") {
  ...
  REQUIRE(f.second.find(
              {GaloisFieldDict::from_vec({3_z, 5_z, 1_z}, 11_z), 1}) == ++it);
  REQUIRE(f.second.find({GaloisFieldDict::from_vec({4_z, 3_z, 2_z, 1_z}, 11_z),
                         1}) == ++it);
  ...
  REQUIRE(it == f.second.begin());
  REQUIRE(f.second.find(
              {GaloisFieldDict::from_vec({5_z, 9_z, 1_z}, 11_z), 1}) == ++it);
  REQUIRE(f.second.find(
  ...
  REQUIRE(f.second.find({GaloisFieldDict::from_vec({8_z, 1_z}, 11_z), 1}) ==
          ++it);
  REQUIRE(f.second.find(
              {GaloisFieldDict::from_vec({2_z, 2_z, 1_z}, 11_z), 1}) == ++it);
  REQUIRE(f.second.find(
              {GaloisFieldDict::from_vec({2_z, 9_z, 1_z}, 11_z), 2}) == ++it);
  REQUIRE(f.second.find(
              {GaloisFieldDict::from_vec({9_z, 0_z, 1_z}, 11_z), 1}) == ++it);
  REQUIRE(
      f.second.find({GaloisFieldDict::from_vec({7_z, 0_z, 5_z, 0_z, 1_z}, 11_z),
                     1}) == ++it);
  REQUIRE(
      f.second.find({GaloisFieldDict::from_vec({7_z, 0_z, 6_z, 0_z, 1_z}, 11_z),
                     2}) == ++it);
  REQUIRE(
  ...
  REQUIRE(it == f.second.begin());
  REQUIRE(f.second.find(
              {GaloisFieldDict::from_vec({5_z, 4_z, 1_z}, 11_z), 1}) == ++it);
  REQUIRE(f.second.find({GaloisFieldDict::from_vec({2_z, 8_z, 6_z, 1_z}, 11_z),
                         1}) == ++it);
  REQUIRE(f.second.find({GaloisFieldDict::from_vec({2_z, 9_z, 9_z, 1_z}, 11_z),
                         2}) == ++it);
  ...
  d1 = GaloisFieldDict::from_vec({38_z, 39_z, 41_z, 26_z, 5_z, 2_z, 1_z}, 53_z);
  f = d1.gf_factor();
  REQUIRE(f.second.size() == 2);
  REQUIRE(f.first == 1_z);
  REQUIRE(f.second.find({GaloisFieldDict::from_vec({26_z, 44_z, 1_z}, 53_z),
                         1}) == f.second.begin());
  REQUIRE(f.second.find(
...
TEST_CASE("GaloisFieldDict eval : Basic", "[basic]") {
  ...
  d1 = GaloisFieldDict::from_vec({0_z, 2_z, 1_z, 3_z, 4_z, 2_z, 3_z, 0_z, 1_z},
                                 11_z);
  ...
  d1 = GaloisFieldDict::from_vec({5_z, 3_z, 1_z, 0_z, 6_z, 4_z, 0_z, 0_z, 4_z},
                                 11_z);
