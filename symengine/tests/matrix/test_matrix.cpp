...
TEST_CASE("test_get_set(): matrices", "[matrices]") {
  ...
  // Test for CSRMatrix
  CSRMatrix B = CSRMatrix(
      3, 3, {0, 2, 3, 6}, {0, 2, 2, 0, 1, 2},
...
TEST_CASE("test_dense_dense_addition(): matrices", "[matrices]") {
  ...
  REQUIRE(C ==
          DenseMatrix(2, 2, {integer(2), integer(1), integer(-3), integer(2)}));
  ...
  REQUIRE(C == DenseMatrix(1, 4, {add(integer(3), symbol("a")),
...
TEST_CASE("test_row_join(): matrices", "[matrices]") {
  DenseMatrix A =
      DenseMatrix(2, 2, {symbol("a"), symbol("b"), symbol("c"), symbol("d")});
...
TEST_CASE("test_pivoted_gaussian_elimination(): matrices", "[matrices]") {
  ...
  REQUIRE(B ==
          DenseMatrix(2, 2, {integer(1), integer(2), integer(0), integer(-2)}));
...
TEST_CASE("test_fraction_free_gaussian_elimination(): matrices", "[matrices]") {
  ...
  A = DenseMatrix(3, 3,
                  {integer(1), integer(2), integer(-1), integer(1), integer(0),
                   integer(1), integer(2), integer(-1), integer(4)});
  B = DenseMatrix(3, 3);
  fraction_free_gaussian_elimination(A, B);
...
TEST_CASE("test_pivoted_gauss_jordan_elimination(): matrices", "[matrices]") {
  ...
  A = DenseMatrix(3, 3,
                  {integer(1), integer(2), integer(3), integer(-1), integer(7),
...
TEST_CASE("test_fraction_free_gaussian_elimination_solve(): matrices",
  ...
  REQUIRE(x ==
          DenseMatrix(2, 2, {integer(5), integer(5), integer(2), integer(-1)}));
}
...
TEST_CASE("test_fraction_free_LU(): matrices", "[matrices]") {
  ...
  DenseMatrix b =
      DenseMatrix(4, 1, {integer(10), integer(11), integer(13), integer(30)});
...
TEST_CASE("test_fraction_free_LDU(): matrices", "[matrices]") {
  ...
  A = DenseMatrix(3, 3,
                  {integer(1), integer(2), integer(3), integer(5), integer(-3),
                   integer(2), integer(6), integer(2), integer(1)});
  ...
  REQUIRE(L ==
          DenseMatrix(3, 3, {integer(1), integer(0), integer(0), integer(5),
                             ...
                             integer(1)}));
  REQUIRE(D ==
          DenseMatrix(3, 3, {integer(1), integer(0), integer(0), integer(0),
                             sub(mul(integer(-3), symbol("a")), integer(10)),
                             integer(0), integer(0), integer(0),
                             sub(mul(integer(-3), symbol("a")), integer(10))}));
  ...
  A = DenseMatrix(3, 3,
                  {integer(5), integer(3), integer(1), integer(-1), integer(4),
                   integer(6), integer(-10), integer(-2), integer(9)});
  fraction_free_LDU(A, L, D, U);
...
TEST_CASE("test_from_coo(): matrices", "[matrices]") {
  ...
  CSRMatrix A = CSRMatrix(
      3, 3, {0, 2, 3, 6}, {0, 2, 2, 0, 1, 2},
      {integer(1), integer(2), integer(3), integer(4), integer(5), integer(6)});
  CSRMatrix B = CSRMatrix::from_coo(
      3, 3, {0, 0, 1, 2, 2, 2}, {0, 2, 2, 0, 1, 2},
      {integer(1), integer(2), integer(3), integer(4), integer(5), integer(6)});
  ...
  B = CSRMatrix::from_coo(4, 6, {0, 0, 1, 1, 2, 2, 2, 3},
                          {0, 1, 1, 3, 2, 3, 4, 5},
                          {integer(10), integer(20), integer(30), integer(40),
                           integer(50), integer(60), integer(70), integer(80)});
...
TEST_CASE("test_csr_binop_csr_canonical(): matrices", "[matrices]") {
  ...
  REQUIRE(B ==
          CSRMatrix(3, 3, {0, 3, 6, 9}, {0, 1, 2, 0, 1, 2, 0, 1, 2},
                    {integer(1), integer(7), integer(2), integer(8), integer(9),
...
TEST_CASE("test_diag(): matrices", "[matrices]") {
  ...
  diag(A, d, 1);
  REQUIRE(A ==
          DenseMatrix(4, 4, {integer(0), integer(1), integer(0), integer(0),
...
TEST_CASE("Test Jacobian", "[matrices]") {
  ...
  A = DenseMatrix(4, 1,
                  {add(x, z), mul(y, z), add(mul(z, x), add(y, t)), add(x, y)});
...
TEST_CASE("Test Diff", "[matrices]") {
  ...
  A = DenseMatrix(2, 2,
                  {add(f, z), mul(f, x), add(mul(z, f), add(y, t)), add(f, y)});
  sdiff(A, f, J);
