...
TEST_CASE("eval_double: eval_double", "[eval_double]") {
  ...
  std::vector<std::pair<RCP<const Basic>, double>> vec = {
      ...
      {add(asin(r3),
           add(acos(r3),
               add(atan(r3), add(asec(integer(6)), add(acsc(r4), acot(r4)))))),
       3.570293614860},
      {add(add(sinh(one), add(cosh(one), add(tanh(one), coth(one)))), csch(r3)),
       9.759732838729},
      {add(add(add(asinh(r4), add(acosh(r4), add(atanh(r3), acoth(r4)))),
               csch(r4)),
           acsch(r3)),
       7.336249966045},
      {add(add(sinh(one), add(cosh(one), add(tanh(one), coth(one)))), sech(r3)),
       5.773239267559},
...
TEST_CASE("eval_complex_double: eval_double", "[eval_double]") {
  ...
  std::vector<std::pair<RCP<const Basic>, std::complex<double>>> vec = {
      ...
      {add(add(add(sinh(r3), add(neg(cosh(r4)), add(tanh(r3), neg(coth(r4))))),
               csch(r3)),
           sech(r4)),
       std::complex<double>(1.8376773309548138, 0.1756408412537389)},
      {add(add(asinh(r3), add(neg(acosh(r4)), add(atanh(r3), neg(acoth(r4))))),
           acsch(r3)),
