...
TEST_CASE("Testing addition, subtraction, multiplication of "
  ...
  RCP<const MIntPoly> q1 = MIntPoly::from_dict(
      {x, y, z},
      {{{1, 2, 3}, 2_z}, {{4, 1, 0}, 3_z}, {{0, 1, 2}, 1_z}, {{0, 0, 0}, 7_z}});
...
TEST_CASE("Testing addition, subtraction, multiplication of "
  ...
  RCP<const MIntPoly> q2 = MIntPoly::from_dict({x, y, z}, {{{1, 2, 0}, 1_z},
                                                           {{4, 0, 0}, 3_z},
                                                           {{0, 3, 0}, 4_z},
                                                           {{0, 2, 1}, 2_z},
                                                           {{0, 0, 2}, -1_z},
  ...
  RCP<const MIntPoly> q4 = MIntPoly::from_dict({x, y, z}, {{{1, 4, 1}, -2_z},
                                                           {{4, 2, 1}, -6_z},
                                                           {{0, 5, 1}, -8_z},
...
TEST_CASE("Testing addition, subtraction, multiplication of "
  ...
  RCP<const MIntPoly> q2 = MIntPoly::from_dict({x, y, z}, {{{1, 2, 3}, 1_z},
                                                           ...
                                                           {{0, 0, 0}, 3_z},
                                                           {{2, 0, 0}, 1_z}});
  RCP<const MIntPoly> q3 = MIntPoly::from_dict({x, y, z}, {{{1, 2, 3}, -1_z},
                                                           {{3, 2, 1}, 2_z},
                                                           {{0, 1, 2}, -1_z},
                                                           {{0, 0, 0}, -3_z},
                                                           {{2, 0, 0}, -1_z}});
