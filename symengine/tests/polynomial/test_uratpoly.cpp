...
TEST_CASE("Adding two URatPoly", "[URatPoly]") {
  ...
  RCP<const URatPoly> a =
      URatPoly::from_dict(x, {{0, rc(1_z, 2_z)}, {1, rc(2_z, 3_z)}, {2, 1_q}});
...
TEST_CASE("Multiplication of two URatPoly", "[URatPoly]") {
  ...
  RCP<const URatPoly> e = URatPoly::from_dict(
      x, {{0, 2_q}, {1, rc(ic(-3), 2_z)}, {2, rc(1_z, 4_z)}});
  RCP<const URatPoly> f = URatPoly::from_dict(x, {{0, 1_q}, {1, rc(1_z, 2_z)}});
...
TEST_CASE("Comparing two URatPoly", "[URatPoly]") {
  RCP<const Symbol> x = symbol("x");
  RCP<const Symbol> y = symbol("y");
  RCP<const URatPoly> P = URatPoly::from_dict(x, {{0, 1_q}, {1, rc(2_z, 3_z)}});
  RCP<const URatPoly> Q =
...
TEST_CASE("URatPoly as_symbolic", "[URatPoly]") {
  ...
  REQUIRE(eq(*a->as_symbolic(), *add({div(one, integer(2)), mul(integer(2), x),
                                      pow(x, integer(2))})));

  RCP<const URatPoly> b = URatPoly::from_dict(x, {{1, rc(3_z, 2_z)}, {2, 2_q}});
...
TEST_CASE("Evaluation of URatPoly", "[URatPoly]") {
  RCP<const Symbol> x = symbol("x");
  RCP<const URatPoly> a = URatPoly::from_dict(x, {{0, 1_q}, {1, rc(2_z, 3_z)}});
  RCP<const URatPoly> b =
      URatPoly::from_dict(x, {{0, rc(1_z, 2_z)}, {1, rc(2_z, 5_z)}, {2, 1_q}});
  ...
  std::vector<rational_class> resb = {rc(53_z, 10_z), rc(19_z, 10_z),
                                      rc(1_z, 2_z)};
...
TEST_CASE("Derivative of URatPoly", "[URatPoly]") {
  ...
  RCP<const Symbol> y = symbol("y");
  RCP<const URatPoly> a =
      URatPoly::from_dict(x, {{0, 1_q}, {1, rc(2_z, 3_z)}, {2, rc(1_z, 2_z)}});
...
TEST_CASE("URatPoly pow", "[URatPoly]") {
  RCP<const Symbol> x = symbol("x");
  RCP<const URatPoly> a = URatPoly::from_dict(x, {{0, rc(1_z, 2_z)}, {1, 1_q}});
  RCP<const URatPoly> b = URatPoly::from_dict(x, {{0, 3_q}, {2, rc(3_z, 2_z)}});
