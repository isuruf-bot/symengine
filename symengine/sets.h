...
public:
  UniversalSet() { SYMENGINE_ASSIGN_TYPEID() }
...
public:
  ...
  inline const set_basic &get_container() const { return this->container_; }
};
...
public:
  ...
  inline const RCP<const Number> &get_start() const { return start_; }
  inline const RCP<const Number> &get_end() const { return end_; }
  inline const bool &get_left_open() const { return this->left_open_; }
  inline const bool &get_right_open() const { return this->right_open_; }
};
...
public:
  ...
  inline const set_set &get_container() const { return this->container_; }
...
public:
  ...
  virtual bool __eq__(const Basic &o) const;
  virtual int compare(const Basic &o) const;
  virtual vec_basic get_args() const { return {universe_, container_}; }
  ...
  inline const RCP<const Set> &get_universe() const { return this->universe_; }
...
public:
  ...
  virtual bool __eq__(const Basic &o) const;
  virtual int compare(const Basic &o) const;
  virtual vec_basic get_args() const { return {sym, condition_}; }
  ...
  virtual RCP<const Set> set_complement(const RCP<const Set> &o) const;
  virtual RCP<const Boolean> contains(const RCP<const Basic> &a) const;
  inline const RCP<const Basic> &get_symbol() const { return this->sym; }
...
public:
  ...
  virtual bool __eq__(const Basic &o) const;
  virtual int compare(const Basic &o) const;
  virtual vec_basic get_args() const { return {sym_, expr_, base_}; }
  ...
  inline const RCP<const Basic> &get_symbol() const { return this->sym_; }
  inline const RCP<const Basic> &get_expr() const { return this->expr_; }
  inline const RCP<const Set> &get_baseset() const { return this->base_; }
...
inline bool is_a_Set(const Basic &b) {
  return (b.get_type_code() == EMPTYSET || b.get_type_code() == UNIVERSALSET ||
          ...
          b.get_type_code() == CONDITIONSET || b.get_type_code() == INTERVAL ||
          b.get_type_code() == UNION || b.get_type_code() == IMAGESET);
}
...
inline RCP<const Set> imageset(const RCP<const Basic> &sym,
  ...
  if (is_a_Set(*expr)) {
    for (const auto &s : static_cast<const Set &>(*expr).get_args()) {
      if (not(is_a_Number(*s) or is_a<Constant>(*s) or is_a_Boolean(*s))) {
  ...
  if (is_a<FiniteSet>(*base)) {
    map_basic_basic d;
    set_basic temp;
    for (const auto &s : down_cast<const FiniteSet &>(*base).get_container()) {
      d[sym] = s;
